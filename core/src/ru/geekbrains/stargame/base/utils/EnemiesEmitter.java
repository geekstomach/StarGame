package ru.geekbrains.stargame.base.utils;
...
public class EnemiesEmitter {
    ...
    public EnemiesEmitter(Rect worldBounds, EnemyPool enemyPool, TextureAtlas atlas) {
        ...
        this.enemySmallRegion = ru.geekbrains.stargame.base.utils.Regions.split(textureRegion0, 1, 2, 2);
        TextureRegion textureRegion1 = atlas.findRegion("enemy1");
        this.enemyMediumRegion = ru.geekbrains.stargame.base.utils.Regions.split(textureRegion1, 1, 2, 2);
        TextureRegion textureRegion2 = atlas.findRegion("enemy2");
        this.enemyBigRegion = ru.geekbrains.stargame.base.utils.Regions.split(textureRegion2, 1, 2, 2);
