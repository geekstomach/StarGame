package ru.geekbrains.stargame.base.math;
...
public class MatrixUtils {
     ...
     */
    public static void calcTransitionMatrix(Matrix4 mat, ru.geekbrains.stargame.base.math.Rect src, ru.geekbrains.stargame.base.math.Rect dst) {
     ...
     * @param dst итоговый квадрат
     */
    public static void calcTransitionMatrix(Matrix3 mat, ru.geekbrains.stargame.base.math.Rect src, ru.geekbrains.stargame.base.math.Rect dst) {
        float scaleX = dst.getWidth() / src.getWidth();
        float scaleY = dst.getHeight() / src.getHeight();
